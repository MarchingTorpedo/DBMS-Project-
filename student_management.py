...
def add_student():
    ...
    g = c_gender.get()
    d = e_dob.get()
    a = t_address.get("1.0",END)#here '1' is line number 'one' and '0' means first character of line number 'one'
...
title = Label(master, text="Student Management System", font=("Calibri",40,"bold"), bg="crimson", fg="white", bd=7, relief=GROOVE) #relief = type of border
